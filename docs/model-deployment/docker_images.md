| 框架 | 版本号 | 适用硬件 | 推荐镜像 |
| --- | --- | --- | --- |
| vLLM | 0.15 | BW1100 / BW1000 / K100_AI | `docker pull harbor.sourcefind.cn:5443/hcu/admin/base/vllm:0.15.1-ubuntu22.04-dtk26.04-py3.10` |
...
> **Tips：** 更多镜像获取可见：[SourceFind 开发者平台](https://developer.sourcefind.cn/servicelist)
